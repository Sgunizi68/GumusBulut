...
import { Plus, Edit2, Save, X, Trash2, ChevronDown, ChevronUp, Search } from 'lucide-react';

const FaturaBolmeYonetimi = () => {
                                  ...
                                  <div className="flex space-x-1">
                                    {editingDetay === detay.id ? (
                                      ...
                                      <>
                                        ...
                                        >
                                          <Trash2 className={`w-4 h-4 ${fatura.detaylar.length <= 2 ? 'text-gray-400' : ''}`} />
                                        </button>
                                      </>
                                    )}
                                  </div>
...
export default FaturaBolmeYonetimi;