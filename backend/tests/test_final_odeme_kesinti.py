...
class TestFinalOdemeKesinti(unittest.TestCase):
    def setUp(self):
    ...
    def test_final_case(self):
        """
        Final test case to verify the correct calculation:
        - Two POS transactions on July 1st with Hesaba_Gecis = July 2nd
        - Two matching Odeme records for July 2nd
        """
