...
def create_odemeler_bulk(db: Session, odemeler: List[odeme.OdemeCreate]):
    ...
    for odeme_data in odemeler:
        ...
        db_odeme = models.Odeme(
            Tip=odeme_data.Tip,
            Hesap_Adi=odeme_data.Hesap_Adi,
            Tarih=odeme_data.Tarih,
            Aciklama=odeme_data.Aciklama,
            Tutar=odeme_data.Tutar,
            Kategori_ID=odeme_data.Kategori_ID,
            Donem=odeme_data.Donem,
            Sube_ID=odeme_data.Sube_ID
        )
        db.add(db_odeme)
        added_count += 1
